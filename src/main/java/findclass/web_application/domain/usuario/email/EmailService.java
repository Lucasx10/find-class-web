package findclass.web_application.domain.usuario.email;
...
public class EmailService {
    ...
    private static final String EMAIL_ORIGEM = "findclass@email.com";
    private static final String NOME_ENVIADOR = "Plataforma Find Class";
    ...
    public void enviarEmailSenha(Usuario usuario) {
        ...
        String conteudo = gerarConteudoEmail("Olá [[name]],<br>"
                ...
                + "Obrigado,<br>"
                + "Plataforma Find Class.", usuario.getNome(), URL_SITE + "/recuperar-conta?codigo=" + usuario.getToken());
    ...
    public void enviarEmailSenhaAleatoria(Usuario usuario, String senhaAleatoria) {
        String assunto = "Bem-vindo à Plataforma Find Class  | Dados de Acesso ";
        String conteudo = gerarConteudoBoasVindas("Olá [[name]],<br>"
                ...
                + "Obrigado,<br>"
                + "Plataforma Find Class.", usuario.getNome(), usuario.getUsername(), senhaAleatoria);
